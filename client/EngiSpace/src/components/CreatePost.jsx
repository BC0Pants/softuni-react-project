...
import { useAppwriteUpload } from "../hooks/useAppwriteUpload.js";
const CreatePost = () => {
    ...
    <div className="min-h-screen bg-[#1e1e2e] pt-16">
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          <h1 className="text-3xl text-[#89b4fa] font-bold mb-8">
            Create New Post
          </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="title" className="block text-[#a6adc8] mb-2">
                Title
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="body" className="block text-[#a6adc8] mb-2">
                Content
              </label>
              <textarea
                id="body"
            ...
            <div>
              <label htmlFor="image" className="block text-[#a6adc8] mb-2">
                Image (optional)
              </label>
              <input
                type="file"
